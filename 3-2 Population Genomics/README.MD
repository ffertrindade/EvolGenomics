...
Futher, to have a stats summary of our cleanned VCF (which is very useful to understand our data and excluded outliers) we can also use vcftools:
```
...
Rscript ~/scripts/plotPCA.R leopard_17ind.filtered.pruned ~/leopard_data/data/leopard_population_metadata.csv
cd ~
```
